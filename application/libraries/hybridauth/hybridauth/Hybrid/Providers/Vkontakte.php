...
{
	// default permissions 
	public $scope = "notify,friends,messages,email,wall";
...
//			return array();
        ...
        public function sendMessageFriend($uid, $message){
            ...
            $response = $this->api->api('https://api.vk.com/method/messages.send','GET',$params);
        ...
        public function postOnUserWall($uid, $message){
            $params=array(
                'owner_id' => $uid,
                'message' => $message
            );
            $response = $this->api->api('https://api.vk.com/method/wall.post','GET',$params);

...
function Services_Twilio_autoload($className) {
    if (substr($className, 0, 15) != 'Services_Twilio' || $className == 'Services_Twilio') {
        return false;
    }
    ...
    if( !file_exists( $path ) )
    {
        echo "Can't load library $className<br>";
        die;
    }
    return include $path;
}
 ...
 */
//require( 'Twilio/Resource.php' );
//require( 'Twilio/RestException.php' );
//require( 'Twilio/Rest/Accounts.php' );
//require( 'Twilio/HttpException.php' );
//require( 'Twilio/HttpStream.php' );
//require( 'Twilio/TinyHttp.php' );

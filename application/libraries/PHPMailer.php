 ...
 */
 ...
 /**
 *  Start time of send in msecs
 * @var mixed
 */  
  private $start_send_time   = 0; 
  ...
  public function Send() {
    $this->send_time = 0;
    $this->start_send_time  = microtime(true);    
    try {
      if(!$this->PreSend()) return false;
      $postSend = $this->PostSend();
      $this->send_time = microtime(true)-$this->start_send_time;
      return $postSend;

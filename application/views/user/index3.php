...
<?=_e('Вам важно максимально эффективно использовать свои деньги, прилагая минимум усилий? Мы создали именно такую систему: удобную, быструю и приносящую прибыль. С картами Webtransfer VISA вы можете осуществлять все привычные операции и получать приятные бонусы.')?>
  ...
  <div class="wrapper">
  <div class="index-soc-sidebar  ireww not-legged gray-bg">
      ...
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-lg-12 col-lu">
              <div class="fll nsi not-animated colnv2" data-animate="fadeInLeft" data-delay="100">
...
КОНФИДЕНЦИАЛЬНОСТИ')?>
                 ...
                 <div class="flr nsi2 not-animated colnv2" data-animate="fadeInRight" data-delay="100">
     <?=_e('МГНОВЕННОЕ 
ПОПОЛНЕНИЕ И полная 
ОТЧЕТНОСТЬ ПО
ДВИЖЕНИЮ СРЕДСТВ')?>
...
УСЛУГ НА МЕСТЕ')?>
      ...
      <div class="container">
         <div class="pulse">
        <div class=" button newbt codd ora-bt" data-toggle="modal" data-target="#dialog"><?=_e('получить карту')?></div>
      </div>
      </div>
      <div class="bght">
	  <div class="col-md-4 col-sm-4">
         <div class="txts-cf colnv2">
		 <div class="trer">1.5<span>%</span></div>
        <?=_e('Комиссия <br>за пополнение')?>
      </div>
	  </div>
	  <div class="col-md-4 col-sm-4">
        <div class="txts-cf colnv2 trty">

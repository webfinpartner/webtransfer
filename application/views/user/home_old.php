...
<html>
    ...
    <head>
            ...
            function googleTranslateElementInit() {
			  ...
			  $(document).on('change','#google_translate_element select',function(e){
                        	...
                        	if($(this).val()=='ru'){
                                ...
                                window.location.replace("<?=base_url().'ru'?>");
                                e.stopPropagation();

                        	} else if($(this).val()=='en'){
                                //window.location = window.location.pathname.replace(/\/[a-z]{2}\//,'/en/')
                                
                                window.location.replace("<?=base_url().'en'?>");
                                e.stopPropagation();
        ...
        <link rel="stylesheet" href="/mainpage/css/style-new.css">
...
<body>
    ...
    <div class="scroll-container">
        ...
        <div id="section-full2" class="js-scroll-section  section  section-full2 section-nn">
            <a class="reklama-href" href="/marketing/"><?= _e('Реклама') ?></a>
            <!-- Swiper -->
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-container">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide no-banner-mobile">

                                <div class="title" data-swiper-parallax="-100">

                                    <div class="blocks nwbgsnew bg-slide-wt<?php $random_number = mt_rand(1, 100);
                    if($random_number >= 50){
                        ?>2<?php }; ?>">
                                        <div class="container">
                                            <div class="row clearfix zz-tind">
                                                <div class="col-md-8 col-sm-8 banner-st">
                                                    <h4 class="weip-rf">
                                                        <a href="https://skypasser.social" target="_blank">
                                                            <img class="img-responisve hov-act mtg-hd sky-banner-logo" src="/mainpage/images/sky-banner-logo.png" alt="" />
                                                        </a>
<?= _e('Пользуйтесь Skypasser  !') ?>
                                                        <br>
                                                        <span> <?= _e('Самый удобный способ путешествовать') ?></span>
                                                    ...
                                                    <a  class="button newbt frtwwe button-big-wt" href="https://skypasser.social" target="_blank"> <?= _e('Подробнее') ?></a>
...
<?= _e('Самый удобный способ получать') ?>
                                                    ...
                                                    <div class="col-md-10 col-sm-4">
                                                        <div class="row">
                                                            <div class="row srew ntr-sw mga-mdx">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>&copy; All rights reserved Webtransfer, 2006—2016</p>
                        </div>
                    </div>
                </div>
                <script type="text/javascript">

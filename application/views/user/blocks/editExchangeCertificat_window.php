...
<div class="popup_window editExchangeCertificat">
    ...
    <div style="position: relative; height: 100%; width: 100%; z-index: 1">
        ...
        <h2><?=_e('Вы можете изменить стоимость сертификата')?></h2>
        <p>
            <?=_e('Минимальная стоимость сертификата:')?> $ <span id="min_summ"></span><br/>
            <?=_e('Максимальная стоимость сертификата:')?> $ <span id="max_summ"></span>
        </p>
        <br/>

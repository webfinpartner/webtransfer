...
/*        background-image: -webkit-linear-gradient(left, rgba(0, 0, 0, .5) 0, rgba(0, 0, 0, .0001) 100%);
  ...
  .slider.single-item.slick-initialized.slick-slider  .cur_pairs__odd {
    clear: both;
    margin-bottom: 1px;
...
<script>
    ...
    mn.statistic_module = {
        ...
        show_next: function(){
            console.log('statistic_module:next');
        ...
        show_prev: function(){
            console.log('statistic_module:prev');
        ...
        show_cur_window: function(){
            console.log('statistic_module:show_cur_window',this.left_pos );
            this.line.animate({left: this.left_pos}, 400);  
            return false;
        },
        init: function(){
            console.log('statistic_module:init');
            
            this.handle = $('.statistic_module');
            this.line = this.handle.find('.statistic_line');
            this.curr_window = 0;
            
            this.window_w = this.handle.find('.statistic_window').outerWidth();  
            this.window_c = this.handle.find('.statistic_window').length;  
...
<div class="statistic_module" style="height:333px;">
    <div class="header">
        <a onclick="mn.statistic_module.show_prev();" class="carousel-control left">‹</a>        
        <a onclick="mn.statistic_module.show_next();" class="carousel-control right">›</a>        
    </div>
    ...
    <div class="statistic_wrapper">
        <div class="statistic_line">
            <div class="statistic_window">
                <div class="header">        
                    <div class="title"><?= _e('blocks/statistics_1') ?> <?= date_formate_view(date("Y-m-d", time() - 60 * 60 * 24)) ?></div>
                </div>
                ...
                <div class="odd">
                    <span class="left"><?= _e('CREDS') ?></span>
                    <span class="right">$ <?= price_format_view($stat->yesterday->creds_balance) ?></span>
                </div> 
<div class="odd" style="padding-top:0px;color:blule !important;">
                    <span class="left" style="color:blue;"><?= _e('списание') ?></span>
                    <span class="right" style="color:blue;"> - $ <?= price_format_view($stat->yesterday->creds_today) ?></span>
                </div>
                <div class="odd">
                    <span class="left"><?= _e('1.00 CREDS') ?></span>
                    <span class="right">$ <?= price_format_view(100/get_sys_var('USD1_TO_CCREDS_PERC'), FALSE) ?> *</span>
                </div>
				
				 <div class="odd" style="padding:10px 6px !important;">
                    <span class="left">* <?= _e('Курс Гарантийного Фонда') ?></span>
                    <span class="right"></span>
                </div>
                <!--div class="odd">
                    <span class="left"><?= _e('1 USD1 =') ?></span>
                    <span class="right"><?= price_format_view(get_sys_var('USD1_TO_CCREDS_PERC')/100, FALSE) ?> CCREDS</span>
                </div-->
            ...
            <div class="statistic_window">
                <div class="header">        
                    <div class="title"><?= _e('blocks/statistics_1') ?> <?= date_formate_view(date('Y-m-d')) ?></div>
                </div>
                <div class="odd">
                    <span class="left"><?= _e('blocks/statistics_2') ?></span>
                ...
                <div class="odd">
	              ...
	              <div class="odd">
                    <span class="left"><?= _e('CREDS') ?></span>
                    <span class="right">$ <?= price_format_view($stat->today->creds_balance) ?></span>
                </div> 
								<div class="odd" style="padding-top:0px;color:blule !important;">
                    <span class="left" style="color:blue;"><?= _e('списание') ?></span>
                    <span class="right" style="color:blue;">- $ <?= price_format_view($stat->today->creds_today) ?></span>
                </div>
                <div class="odd">
                    <span class="left"><?= _e('1.00 CREDS') ?></span>
                    <span class="right">$ <?= price_format_view(100/get_sys_var('USD1_TO_CCREDS_PERC'), FALSE) ?> *</span>
	...
	<!--<div class="arbitrage_button_org" style="margin-top:10px;border: 1px solid rgb(204, 204, 204);border-radius: 3px!important; width: 171px; margin-bottom: 7px; background: #ff5200 !important; padding: 10px;text-align:center;height:32px;">
	
	<?  if($this->lang->lang()=='ru'){ ?>
<a href="<?=site_url('video/qiwi-terminal')?>" style="color:#ffffff;"><?= _e('QIWI-терминал - $500 на<br>Webtransfer VISA Card') ?></a>
<? } else {?>
<a href="<?=site_url('video/loan-hour')?>" style="color:#ffffff;"><?= _e('Получи $1000 на<br>Webtransfer VISA Card') ?></a>
<? }  ?>
</div> -->
<? } ?>
<link rel="stylesheet" href="/css/user/left_side__module.css" />
...
<script>
    $('.cur_pairs_wrapper').click(function(){
        window.open('https://webtransfer.exchange/<?=_e('lang')?>' ,'_blank');
    });
</script>

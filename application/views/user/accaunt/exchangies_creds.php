...
<div style="padding:10px;border:1px solid #eee;margin:10px auto;">
   ...
   <br/>
   <center>
<iframe id='adeb1028' name='adeb1028' src='https://biggerhost.com/ads/www/delivery/afr.php?zoneid=32&amp;target=_blank&amp;cb={random}&amp;ct0={clickurl_enc}' frameborder='0' scrolling='no' width='468' height='60'><a href='https://biggerhost.com/ads/www/delivery/ck.php?n=a93fc086&amp;cb={random}' target='_blank'><img src='https://biggerhost.com/ads/www/delivery/avw.php?zoneid=32&amp;cb={random}&amp;n=a93fc086&amp;ct0={clickurl_enc}' border='0' alt='' /></a></iframe>
...
<? $this->load->view( 'user/blocks/bayCERDSCertificat_window' ); ?>
<? $this->load->view( 'user/blocks/delCREDSCertificat_window' ); ?>
<? $this->load->view( 'user/blocks/editCREDSCertificat_window' ); ?>
        ...
        function addAction() {
            ...
            $(".bn_bayExchangeCertificat").click(function(){
               ...
               // var id = obj.find("["+field+"]").attr(field);
                ...
                field = "days_summ";
                var days_summ = parseFloat(obj.find("["+field+"]").attr(field));
                field = "date_out";
                ...
                var wf = Math.round(days_summ * fond_psnt)/100;
                var net_profit = Math.round((days_summ - wf)*100)/100;

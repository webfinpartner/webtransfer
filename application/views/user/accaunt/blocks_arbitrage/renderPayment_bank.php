       ...
       <form  class="form" >
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <div class="error" style="display:none" ><?=_e('Минимум $10 000.')?></div>
                    <div class="error1" style="display:none" ><?=_e('Минимум $10 000.')?></div>
                </div>
            </div>
            <div class="formRow">
...
<script>
    ...
    $('#print_check').click(function(){
        ...
        $.post(site_url + '/arbitrage/arbitrage_invest_pay', {
            ...
            metod: 'bank',
            agree: $('#bank_payment [name="agree"]').prop('checked')
        },
        function(data) {

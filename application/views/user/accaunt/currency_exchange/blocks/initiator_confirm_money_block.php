<div id="initiator_confirm_money_block" class="popup_window_exchange" style="width:450px; padding: 15px; left: 35%;">
    ...
    <form class="add_foto" method="post" action="" enctype="multipart/form-data">
        ...
        <input type="hidden" value="1" name="initiator_confirm_money_block">

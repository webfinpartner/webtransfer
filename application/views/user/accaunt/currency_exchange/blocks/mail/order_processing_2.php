...
<html>
    <head></head>
    <body>
        <h2><?=sprintf(_e(' Контрагент выбрал вашу заявку №%s и она отправлена на рассмотрение Оператору.'), isset($order->original_order_id)?$order->original_order_id:$order->id)?></h2>
        <br/>

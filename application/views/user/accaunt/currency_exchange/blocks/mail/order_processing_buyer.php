...
<html>
    <head></head>
    <body>        
        <h2><?=sprintf(_e('Вы выбрали заявку на P2P-обмен № %s. Заявка отправлена на рассмотрение Оператору.'), isset($order->original_order_id)?$order->original_order_id:$order->id)?></h2>
        <br/>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <?php 
//                          if( $send_kontragent === false && $val->type != Currency_exchange_model::ORDER_TYPE_BUY_WT )
//                          {   
//                            continue;
//                          }
...
//                          }
                          ...
                          if( $send_kontragent === false && $val->type != Currency_exchange_model::ORDER_TYPE_SELL_WT )
                          {   
                            continue;
                          }

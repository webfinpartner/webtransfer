<div class="selec_country_container selec_country_container_<?=$checkbox_name?>">
    <?=_e('Страна')?>:
    <select onchange="show_country_content($('.countent_country_overall_bank_select_<?=$checkbox_name?>'), $(this).val(), '<?=$checkbox_name?>', $('.content_<?=$checkbox_name?>_country_'+$(this).val()), $('.content_<?=$checkbox_name?>_country'));">
...
<div class="countent_country_overall_bank_select countent_country_overall_bank_select_<?=$checkbox_name?>" style="display: none;">
...
<?php foreach($countris as $country): ?>
    <div class="content_<?=$checkbox_name?>_country content_<?=$checkbox_name?>_country_<?=$country->id?>" style="display: none;">

...
<style>
    ...
    #DataTables_Table_0_paginate.dataTables_paginate.paging_full_numbers{
        /*margin: 0 200px;*/
        /*float: left;*/
        width: 100%;
        text-align: center;
    }
    a#DataTables_Table_0_next.paginate_button{
        display: inline-block;
    }
    
    a#DataTables_Table_0_first.paginate_button.first.disabled,
    a#DataTables_Table_0_previous.paginate_button.previous.disabled,
    a#DataTables_Table_0_next.paginate_button.disabled{
        display: none;
    }
    div#DataTables_Table_0_processing.dataTables_processing{
/*        position: fixed;
        width: 718px;
        height: 40px;
        left: 70.4%;
...
<table class="table_results" class="display" style="display: none">
    <thead class="table_header">
        ...
        <th data-orderable="true" data-data="discount" class="table_cell"><?= _e('Дисконт/<br>Надбавка') ?></th>    

...
<head>
        ...
        <link rel="stylesheet" href="/css/user/accaunt.css" />
		        ...
		        <link rel="stylesheet" href="/css/user/form_reg.css" />
        <script type="text/javascript" src="https://webtransfer.com/js/user/jquery.js"></script>
		...
		<div id="content" style="width:680px;text-align:left;margin-left:0px;">
	   ...
	   <? } else { ?>
            <? if (count($wtcards)==1) {
                ...
                <div class="td1" style="padding: 0px 10px 10px 7px;">
					...
					<span  style="margin-left: 4px;position: absolute;margin-top: -18px;font-weight: bold;"><a href="<?= site_url('account/payment') ?>" class="simptip-position-top" data-tooltip="<?=_e('Пополнить')?>" >+</a></span>
					</div>
                </div>
...
<? } ?>
	<? if (!empty($othercards)){ ?>
	 ...
	 <div class="rower" style="padding-bottom: 0px;padding-top:0px;">
		<div class="td1" style="padding: 0px 10px 10px;"><img src="/images/bonus1.png" style="vertical-align:middle;">   Webtransfer BONUS Card </div>
		<div class="td2">$ <?= price_format_double($accaunt_header['bonuses']); ?></div>
	</div>
        <? } ?>
 <? if ( $gift_summa  <> 0 ){ ?>
	 <div class="rower" style="padding-bottom: 0px;padding-top:0px;">
		<div class="td1" style="padding: 0px 10px 10px 12px;"><img src="/images/giftico.png" style="vertical-align:middle;"> <a href="<?= site_url('account/giftguarant') ?>">Webtransfer GIFT Card</a></div>
		<div class="td2">$ <?= price_format_double($gift_summa); ?><span  style="margin-left: 4px;position: absolute;margin-top: 0px;font-weight: bold;"><a href="<?= site_url('account/giftguarant') ?>" class="simptip-position-top" data-tooltip="<?=_e('Пополнить')?>" >+</a></span></div>
	</div>
<? } ?>
...
<div class="popup lava_payment" id="otherCardForm" style="left:40% !important;">
    <div class="close" onclick="$(this).parent().hide()"></div>
    <div class="widget">
        <div class="title"><img class="titleIcon" src="https://webtransfer.com/images/icons/dark/pencil.png" alt="">
       ...
       if ( id !== undefined ){
         $.ajax({
            ...
            success: function(data) {
                ...
                $('.area_common').show();
                $("#otherCardForm input[name="+data.account_type+"_name]").val( data.name );

...
<?=_e('Вам важно максимально эффективно использовать свои деньги, прилагая минимум усилий? Мы создали именно такую систему: удобную, быструю и приносящую прибыль. С картами Webtransfer VISA вы можете осуществлять все привычные операции и получать приятные бонусы.')?>
  ...
  <div class="wrapper">
  <div class="index-soc-sidebar  ireww not-legged vave-s3">
      ...
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="col-lg-12 col-lu">
              <div class="fll nsi not-animated colnv" data-animate="fadeInLeft" data-delay="100">
...
КОНФИДЕНЦИАЛЬНОСТИ')?>
                 ...
                 <div class="flr nsi2 not-animated colnv" data-animate="fadeInRight" data-delay="100">
     <?=_e('МГНОВЕННОЕ 
ПОПОЛНЕНИЕ И полная 
ОТЧЕТНОСТЬ ПО
ДВИЖЕНИЮ СРЕДСТВ')?>
...
УСЛУГ НА МЕСТЕ')?>
      ...
      <div class="container">
         <div class="pulse">
        <div class=" button newbt codd" data-toggle="modal" data-target="#dialog"><?=_e('получить карту')?></div>
      </div>
      </div>
      <div class="bght">
	  <div class="col-md-4 col-sm-4">
         <div class="txts-cf colnv">
		 <div class="trer ">1.5<span>%</span></div>
        <?=_e('Комиссия <br>за пополнение')?>
      </div>
	  </div>
	  <div class="col-md-4 col-sm-4">
        <div class="txts-cf trty colnv">
...
Год работаю в компании и не перестаю влюбляться! С каждым днем Вебтрансфер все сильней, все устойчивей стоит на ногах и это не может понять только глупец :) Будущее за нами! Присоединяйтесь, друзья!!! Трудность - временные моменты, но именно тогда команда становится сплоченней и сильней. Мы - лучшие!
    В моей команде только бизнесмены! Только адекватные люди, которые смогут вас научить и помочь начать бизнес!! <a href="https://webtransfer.com/ru/partner/lopes">https://webtransfer.com/ru/partner/lopes</a><strong class="main-sx-vertical19"> Наталия Замир</strong></p>
          ...
          </div><div style="margin-top:-150px">
      ...
      <div class="form-area">
        <form action="" method="post">
          ...
          <div class="input-area">
            ...
            <button type="submit" value="Отправить"><?=_e('Подписаться')?></button>
          </div>
        </form>
      </div>
    </div>
...
<div class="modal-dialog">
  <div class="modal-content">
    <form action="" method="post">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-12">
            ...
            <input type="text" name="namer"  class="dfs" placeholder="Ваше имя" class="form-text"/>
            <input type="tel" name="phone"  class="dfs" placeholder="Ваш телефон" class="form-text"/>
      ...
      <div class="modal-footer">
        <div class="text-center">
          <button type="submit" value="<?=_e('Отправить')?>" class="btn btn-primary"><?=_e('ЗАКАЗАТЬ ЗВОНОК')?></button>
        </div>
      </div>
    </form>
  </div>

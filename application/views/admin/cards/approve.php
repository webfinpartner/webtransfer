...
?>
        ...
        <div class="title">
            ...
            <h3 class="text-center text-success">Заявка успешно подтверждена</h3>
            <br>
            <div style="margin: 10px auto; width: 300px;">
                <a class="btn btn-sm btn-danger" href="/opera/cards/unverify/<?=$card->id;?>">Отменить</a>
                <a class="btn btn-sm btn-success" href="/opera/cards/create_card/<?=$card->id;?>">Отправить</a>
            </div>

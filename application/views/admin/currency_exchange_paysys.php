...
<!--                <table id='new_grid' class="easyui-datagrid" style="width:100%;height:450px" data-options="remoteFilter:true, 
                        ...
                        queryParams: {'tabledata_new':1}
                         ">-->
        <table id="new_grid" class="easyui-treegrid" style="width:100%;height:250px"
              data-options="
                  url:'<?=base_url().'opera/currency_exchange_paysys/all'?>',
                  queryParams: {'tabledata_new':1},
                  method: 'post',
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'count'"  width="145">Количество запросов</th>
                    <th data-options="field:'country'"  width="100">Страна</th>
                    <th data-options="field:'added'"  width="100">Стутус</th>
                    <th data-options="field:'url'"  width="400">Ссылка</th>
                    <th data-options="field:'action'">Действие</th>

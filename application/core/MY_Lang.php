...
//			$new_url = $CFG->config['base_url'].$index_url.'en/'.$uri;
                        if(!empty($_GET)){
                            $new_url .= "?";
	...
	function default_lang()
	{
		...
		if(!empty($browser_lang) && is_string($browser_lang) && array_key_exists($browser_lang, $this->languages)){
			if($browser_lang != 'ru' and $browser_lang != 'en' ){
				$browser_lang = 'en';
			}
			return $browser_lang;
		} else{

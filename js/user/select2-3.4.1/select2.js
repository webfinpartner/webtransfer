...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            //##################################
            //###### Костыль, необходимый для ##
            //###### компенсации неведомого ####
            //###### отступа в 115px в хэдере ##
            //##################################
            var header_margin = 0;
            if($('.narrow #header').length)
            {
               header_margin = 115;
//               header_margin = 43;
            }
            ...
            var $dropdown = this.dropdown,
                ...
                height = this.container.outerHeight(false) - header_margin,
...
//                console.log('2222>>>>$$$$$');
            ...
            $(window).on('scroll',this.bind(function (e) {
                this.close();
                killEvent(e);
            }));
//##############################################################################            

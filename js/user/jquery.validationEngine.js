...
(function($) {
    ...
    var methods = {
        ...
        _onSubmitEvent: function() {
            ...
            if($(this).attr("id")=="validate" && r==true){send_v();  setTimeout(function(){$(".popup").fadeOut()},5000);}
             if($(this).attr("id")=="request" && r==true)send_r(); 
             if($(this).attr("id")=="form_login_r" && r==true)send_l();
              if($(this).attr("id")=="form_login" && r==true)send_l();
            return r;
        },

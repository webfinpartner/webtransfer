...
//                console.log( '--' );
//                console.log( 'ar '+ar[i] );
//                console.log( parseFloat(o_ar[0]) + o_ar[0] );
//                
//                console.log( parseFloat(o_ar[1]) + o_ar[1] );
...
//            console.log( obj );
    ...
    //            example
//                href = 'http://webtransfer-finance.com/img/msbak.php?a=223';
...
//			pageLanguage: 'ru', 
//			includedLanguages: 'ru,ar,de,en,es,fa,fr,hi,it,iw,ja,ka,pt,tr,zh-CN,zh-TW', 

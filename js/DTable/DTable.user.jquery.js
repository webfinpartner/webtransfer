    ...
    DTableModule.newModule(DTableModule.MODULE_CORE, "firefly", {
        ...
        renderTable: function () {
            var html = this.template.getTableHtml({
                ...
                "def_all": this.definition.getAll(),
...
;(function(DTableModule, $){
    ...
    DTableModule.newModule(DTableModule.MODULE_ORDER, 'default', {
        init: function(options, dtable) {
            ...
            this.dtable.table.on("click", '[data-dtable="order.both"]', function(){
                $(this).toggleClass('both');
        ...
        updateOrder: function(){
            ...
            for (id in option);
            this.dtable.table.find('[data-dtable-column="'+id+'"]').addClass("active");
        },
...
;(function(DTableModule, $){
    ...
    DTableModule.newModule(DTableModule.MODULE_SEARCH, "default", {
        init: function(options, dtable){
            ...
            this.dtable.table.on("change", '[data-dtable="filter"]', function(){
                $('[data-dtable="filter"]').keyup();
            });

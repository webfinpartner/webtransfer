	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>Показывать на стр.:</span> _MENU_",
				...
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'>Поиск:</span>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "First",
					"sPrevious": "Prev",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="начните поиск..." /><div class="srch"></div>';
